...
import net.sparkeek.t2c.mvp.repoList.ControllerRepoList;
...
public class ActivityMain extends AppCompatActivity {
    ...
    @Bind(net.sparkeek.t2c.R.id.ActivityMain_ViewGroup_Container)
    ...
    protected void onCreate(final Bundle poSavedInstanceState) {
        ...
        setContentView(net.sparkeek.t2c.R.layout.activity_main);
