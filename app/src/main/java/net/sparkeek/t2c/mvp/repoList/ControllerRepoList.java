package net.sparkeek.t2c.mvp.repoList;
...
import net.sparkeek.t2c.mvp.cashDisplay.ControllerCashDisplay;
import net.sparkeek.t2c.mvp.changehandlers.CircularRevealChangeHandlerCompat;
import net.sparkeek.t2c.mvp.repoDetail.ControllerRepoDetail;
...
public class ControllerRepoList
    ...
    @Bind(net.sparkeek.t2c.R.id.ControllerRepoList_ProgressBar_Loading)
    ProgressBar mProgressBarLoading;
    @Bind(net.sparkeek.t2c.R.id.ControllerRepoList_RecyclerView)
    RecyclerView mRecyclerView;

    @Bind(net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Empty)
    SwipeRefreshLayout mSwipeRefreshLayoutEmpty;
    @Bind(net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Error)
    SwipeRefreshLayout mSwipeRefreshLayoutError;
    @Bind(net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Content)
    SwipeRefreshLayout mSwipeRefreshLayoutContent;
    @Bind({
            net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Empty,
            net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Error,
            net.sparkeek.t2c.R.id.ControllerRepoList_SwipeRefreshLayout_Content
    })
    ...
    protected View onCreateView(@NonNull final LayoutInflater poInflater, @NonNull final ViewGroup poContainer) {
        final View loView = poInflater.inflate(net.sparkeek.t2c.R.layout.controller_repo_list, poContainer, false);
