package net.sparkeek.piggybank.tests.ui;
...
import net.sparkeek.piggybank.mvp.ActivityMain;
...
public class TestActivityRepoList extends AbstractRobotiumTestCase<ActivityMain> {
    ...
    public void test_ListRepos_WithOneRepo_DisplayListWithOnlyThisRepo() {
        Given:
        {
            final String lsOneRepoJSONData = mLocalifyClient.localify().loadRawFile(net.sparkeek.piggybank.test.R.raw.repos_octocat);
